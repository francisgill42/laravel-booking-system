            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                  ...
                  <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('room_id[]', $rooms, $location->rooms, ['class' => 'form-control js-example-basic-multiple select2', 'required' => '','multiple'=>"multiple"]) !!}
                    <p class="help-block"></p>
             ...
             <div class="row">  
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::textarea('location_description',old('location_description'),['class'=>'form-control', 'rows' => 4, 'cols' => 20]) !!}
            <p class="help-block"></p>

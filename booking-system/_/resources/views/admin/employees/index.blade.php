                        ...
                        @foreach ($employees as $employee)
                            <tr data-entry-id="{{ $employee->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.employees.services',[$employee->id]) }}" class="btn btn-xs btn-warning">@lang('quickadmin.qa_service')</a>
                                    @endcan
                                     @can('leave_access')
                                    <a href="{{ route('admin.leave.leavelist',[$employee->id]) }}" class="btn btn-xs btn-warning">@lang('quickadmin.qa_leave')</a>
                                    @endcan
                                     @can('employee_custom_timing_access')
                                    <a href="{{ route('admin.employeecustomtiming.employeecustomtiminglist',[$employee->id]) }}" class="btn btn-xs btn-warning">@lang('quickadmin.qa_custom_timing')</a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach

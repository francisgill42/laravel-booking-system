...
class WorkingHoursController extends Controller
{
  ...
  public function employeeworkinghours($id)
    {
      ...
      $relations = [
        ...
        $working_hours = WorkingHour::where('employee_id', $id);
      // dd($working_hours);
        return view('admin.working_hours.index', compact('working_hours')+$relations);
    }
    /**

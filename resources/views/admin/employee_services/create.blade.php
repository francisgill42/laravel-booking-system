...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.employees_services.store']]) !!}
...
<a href="{{ route('admin.employees.services',[$employee->id]) }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>

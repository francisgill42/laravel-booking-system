        ...
        <div class="panel-body">
            ...
            <div class="row">  
             <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('postcode', $client->postcode, ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('house_number', $client->house_number, ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('address', $client->address, ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('city_name', $client->city_name, ['class' => 'form-control', 'placeholder' => '','id'=>'city_name']) !!}
            ...
            <div class="row">
                 <div class="col-xs-6 form-group">
                    ...
                    {!! Form::Select('parent_id',$parentClient, $client->parent_id, ['class' => 'form-control select2 parent_id', 'placeholder ' => '']) !!}
                </div>

                 <div class="col-xs-6 form-group email">
                    {!! Form::label('email', 'Email', ['class' => 'control-label']) !!}
                    {!! Form::email('email', $client->email, ['class' => 'form-control input-group ', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('email'))
                        <p class="help-block">
                            {{ $errors->first('email') }}
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('company_name', $client->company_name, ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                 ...
                 <div class="col-xs-6 form-group">
                    ...
                    {!! Form::textarea('comment',$client->comment,['class'=>'form-control', 'rows' => 5, 'cols' => 20]) !!}
            <p class="help-block"></p>

        ...
        <div class="col-md-3">
            <div class="panel panel-default tile">
                ...
                <div class="panel-body tile-body">       
                    ...
                    <div class="col-md-6"><h2><?php echo e($appointments); ?></h2></div> 
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="panel panel-default tile">
                ...
                <div class="panel-body tile-body">       
                    ...
                    <div class="col-md-6"><h2><?php echo e($today_appointment); ?></h2></div> 
                </div>
            </div>
        </div>
  ...
  document.addEventListener('DOMContentLoaded', function() {
   ...
   var location_id =  document.getElementById('location_id_latest').value;
    ...
    views: {
      ...
      events: { url:'<?php echo e(url("admin/get-employees-appointments")); ?>',
       startParam  : 'Dates',

        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('first_name', $client->first_name, ['class' => 'form-control', 'placeholder' => '']); ?>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('last_name', $client->last_name, ['class' => 'form-control', 'placeholder' => '']); ?>
            ...
            <div class="row">  
             <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('postcode', $client->postcode, ['class' => 'form-control', 'placeholder' => '']); ?>
            ...
            <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('house_number', $client->house_number, ['class' => 'form-control', 'placeholder' => '']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('address', $client->address, ['class' => 'form-control', 'placeholder' => '']); ?>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('city_name', $client->city_name, ['class' => 'form-control', 'placeholder' => '','id'=>'city_name']); ?>
            ...
            <div class="row">
                 <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::Select('parent_id',$parentClient, $client->parent_id, ['class' => 'form-control select2 parent_id', 'placeholder ' => '']); ?>
                 ...
                 <div class="col-xs-6 form-group email">
                    ...
                    <?php echo Form::email('email', $client->email, ['class' => 'form-control input-group ', 'placeholder' => '']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('company_name', $client->company_name, ['class' => 'form-control', 'placeholder' => '']); ?>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('phone', $client->phone, ['class' => 'form-control', 'placeholder' => '']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('dob', $client->dob, ['class' => 'form-control date', 'placeholder' => '']); ?>
                 ...
                 <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::textarea('comment',$client->comment,['class'=>'form-control', 'rows' => 5, 'cols' => 20]); ?>

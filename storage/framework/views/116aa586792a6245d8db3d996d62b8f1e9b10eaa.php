<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.locations.store']]); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                   ...
                   <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::select('room_id[]', $rooms, old('room_id'), ['class' => 'form-control js-example-basic-multiple select2', 'required' => '','multiple'=>"multiple"]); ?>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::textarea('location_description',old('location_description'),['class'=>'form-control', 'rows' => 4, 'cols' => 60]); ?>

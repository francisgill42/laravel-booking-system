<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($service, ['method' => 'PUT', 'route' => ['admin.services.update', $service->id]]); ?> 
                            ...
                            <div class="col-xs-6 form-group">
                                ...
                                <select id="tax_rate_id_moneybrid" name="tax_rate_id_moneybrid" class="form-control select2" required>
                                    ...
                                    <?php $__currentLoopData = $taxrate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxrates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($taxrates->moneybird_tax_id); ?>" 
                                            <?php echo e(($service->tax_rate_id_moneybrid == $taxrates->moneybird_tax_id ? "selected":"")); ?>><?php echo e($taxrates->name); ?></option>
                    ...
                    <div id="cost" class="tab-pane fade">
                        ...
                        <div class="col-xs-12 table-responsive ">
                                <table class="table table-bordered table-striped" id="user_table">
                                       ...
                                       <tbody>
                                        <?php $__currentLoopData = $service->extra_cost; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extra_cost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                                            <td><?php echo Form::select('booking_series_type', $bookingservicetype, $extra_cost->booking_series_type, ['class' => 'form-control', 'required' => '','name'=>'booking_series_type[]',]); ?></td>
                                            <td><div class="row"> <div class="col-xs-5"><?php echo Form::time('booking_pricing_time_from',$extra_cost->booking_pricing_time_from,['class' => 'form-control', 'placeholder' => '','name' => 'booking_pricing_time_from[]']); ?></div><div class="col-xs-1">To</div><div class="col-xs-5"><?php echo Form::time('booking_pricing_time_to',$extra_cost->booking_pricing_time_to, ['class' => 'form-control', 'placeholder' => '','name' => 'booking_pricing_time_to[]']); ?></div></div></td>
                                            <td>  <?php echo Form::select('booking_basic_cost_duration_type_unit', $basiccostdurationunit, $extra_cost->booking_basic_cost_duration_type_unit, ['class' => 'form-control','name'=>'booking_basic_cost_duration_type_unit[]']); ?><br/><?php echo Form::text('booking_basic_price',$extra_cost->booking_basic_pricing, ['class' => 'form-control', 'placeholder' => '','name' => 'booking_basic_price[]']); ?></td>
                                            <td> <?php echo Form::select('booking_block_cost_duration_type_unit', $blockcostdurationunit, $extra_cost->booking_block_cost_duration_type_unit, ['class' => 'form-control', 'required' => '','name'=>'booking_block_cost_duration_type_unit[]']); ?><br/><?php echo Form::text('booking_block_price', $extra_cost->booking_block_pricing, ['class' => 'form-control', 'placeholder' => '','name' => 'booking_block_price[]']); ?></td>
...
$(document).ready(function(){
 ...
 var count = <?php echo e(count($service->extra_cost)); ?>;

<?php $__env->startSection('content'); ?>
    <h3 class="page-title"><i class="fa fa-user-circle ifont"></i> <?php echo app('translator')->getFromJson('quickadmin.emailtemplates.title'); ?></h3>
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.emailtemplates.store'], 'files' => true  ]); ?>

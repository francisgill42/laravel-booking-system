                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            ...
                            { 
                              url = BASE_URL+"/admin/get-appointment-exportexcel?searchByName="+$("#searchByName").val()+"&searchByMonth="+$("#searchByMonth").val()+"&SearchByYear="+$("#SearchByYear").val();
                            ...
                            else
                            {
                              ...
                              dt.one('preXhr', function (e, s, data) {
                                  ...
                                  dt.one('preDraw', function (e, settings) {
                                      ...
                                      $.fn.dataTable.ext.buttons.excelFlash.action.call(self, e, dt, node, config);
